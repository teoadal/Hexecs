...
public static class TerrainTypeExtensions
{
    ...
    public static bool IsUrban(this TerrainType type)
    {
        return type is >= TerrainType.UrbanGravel and < TerrainType.Rock;
    }

    public static bool IsRock(this TerrainType type)
    {
        return type is >= TerrainType.Rock and < TerrainType.Swamp;
    }

    public static bool IsSwamp(this TerrainType type)
    {
        return type is >= TerrainType.Swamp and < TerrainType.Mountains;
    }
    ...
    {
        return type >= TerrainType.WaterShallow;
    }
