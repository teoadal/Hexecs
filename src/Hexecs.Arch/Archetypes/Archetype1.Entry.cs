...
internal struct ArchetypeEntry<T1> : IArchetypeEntry<ArchetypeEntry<T1>>
    where T1 : struct, IActorComponent
{
    ...
    public static ArchetypeAccessor<TComponent1>
        GetAccessor<TComponent1>(ref ArchetypeEntry<T1> entry)
    ...
    public static ArchetypeAccessor<TComponent1, TComponent2>
        GetAccessor<TComponent1, TComponent2>(ref ArchetypeEntry<T1> entry)
        where TComponent1 : struct, IActorComponent
    ...
    public static ArchetypeAccessor<TComponent1, TComponent2, TComponent3>
        GetAccessor<TComponent1, TComponent2, TComponent3>(ref ArchetypeEntry<T1> entry)
        where TComponent1 : struct, IActorComponent
        where TComponent2 : struct, IActorComponent
    ...
    public static uint GetId(ref ArchetypeEntry<T1> components)
    {
    ...
    public static ref TComponent TryGetRef<TComponent>(ref ArchetypeEntry<T1> components)
