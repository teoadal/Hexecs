...
public sealed class ActorContextShould(ActorTestFixture fixture) : IClassFixture<ActorTestFixture>
{
    ...
    public void GetExistingComponentWithGetOrAdd()
    {
        ...
        // act
        ref var component = ref fixture.Actors.GetOrAddComponent(actor.Id, id => new Attack { Value = 50 });
    ...
    public void CallHandlerWithValueWhenComponentAdded()
    {
        ...
        fixture.Actors.OnComponentAdded((uint id, int _, in Attack component) =>
        {
            addedActorId = id;
    ...
    public void CallHandlerWithValueWhenComponentRemoved()
    {
        ...
        fixture.Actors.OnComponentRemoving((uint id, in Attack component) =>
        {
            removedActorId = id;
    ...
    public void CallHandlerWhenComponentUpdated()
    {
        ...
        fixture.Actors.OnComponentUpdating((uint id, in Attack oldValue, in Attack newValue) =>
        {
            updatedActorId = id;
