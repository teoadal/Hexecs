    ...
    where TComponent : struct, IActorComponent
{
    ...
    internal ActorComponentConfiguration<TComponent> Build()
    {
        return new ActorComponentConfiguration<TComponent>(_capacity, _cloneHandler, _disposeHandler, _converter);
    }
...
public static class ActorComponentPoolBuilderExtensions
{
    ...
    public static ActorComponentPoolBuilder<TComponent> AddCloneHandler<TComponent>(this ActorComponentPoolBuilder<TComponent> builder)
    ...
    /// </summary>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static ActorComponentPoolBuilder<TComponent> AddDisposeHandler<TComponent>(this ActorComponentPoolBuilder<TComponent> builder)
