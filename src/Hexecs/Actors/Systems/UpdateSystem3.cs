    ...
    where T3 : struct, IActorComponent
{
    ...
    protected virtual void Update(in ActorRef<T1, T2, T3> actor, in WorldTime time)
    {
    }

    protected virtual void Update(ActorFilter<T1, T2, T3>.SkipTakeEnumerator batch, in WorldTime time)
    {
