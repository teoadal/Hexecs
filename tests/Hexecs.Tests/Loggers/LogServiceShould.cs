...
public sealed class LogServiceShould
{
    ...
    public void CheckLevelEnabledCorrectly(LogLevel level)
    {
        ...
        var logService = new LogService([mockSink1.Object, mockSink2.Object]);

        // Act
        bool isEnabled = logService.IsEnabled(level);
    ...
    public void ReturnFalseForIsEnabledWhenNoWriters()
    {
        ...
        // Act
        bool isEnabled = logService.IsEnabled(LogLevel.Info);
    ...
    public void CreateContextLoggerWithStringContext()
    {
        ...
        var logService = new LogService([mockSink.Object]);
        var contextName = "TestContext";

        // Act
        ContextLogger logger = logService.CreateContext(contextName);
    ...
    public void CreateContextLoggerWithTypeContext()
    {
        ...
        // Act
        ContextLogger logger = logService.CreateContext(typeof(LogServiceShould));
    ...
    [AutoData]
    public void WriteMessageWithThreeParametersToAllWriters(
        string context,
        string template,
        int arg1,
        string arg2,
    ...
    [AutoData]
    public void WriteMessageWithFourParametersToAllWriters(
        string context,
        string template,
        int arg1,
        string arg2,
    ...
    [AutoData]
    public void WriteMessageWithFiveParametersToAllWriters(
        string context,
        string template,
        int arg1,
        string arg2,
